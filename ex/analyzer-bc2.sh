...
if [ $COMPARE -eq 1 ] ; then
	/home/jhenry/m2r/src/analyzer_2 -c -i $OUTPUT
else
	if [ $GOPAN -eq 1 ] ; then
		/home/jhenry/m2r/src/analyzer_2 -g -i $OUTPUT
	else
		if [ $YICES -eq 1 ] ; then
			/home/jhenry/m2r/src/analyzer_2 -y -i $OUTPUT
		else
			/home/jhenry/m2r/src/analyzer_2 -i $OUTPUT
		fi
	fi
fi
