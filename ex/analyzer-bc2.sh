...
if [ $COMPARE -eq 1 ] ; then
	/home/jhenry/m2r/src/analyzer_2 -c -b -i $OUTPUT
else
	if [ $GOPAN -eq 1 ] ; then
		/home/jhenry/m2r/src/analyzer_2 -g -b -i $OUTPUT
	else
		if [ $YICES -eq 1 ] ; then
			/home/jhenry/m2r/src/analyzer_2 -y -b -i $OUTPUT
		else
			/home/jhenry/m2r/src/analyzer_2 -b -i $OUTPUT
		fi
	fi
fi
