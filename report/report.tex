...
\abstract{
	Program verification is aims at statically discovering properties on programs,
...
\end{eqnarray*}
% DM: d'habitude on met des ' sur les variables de l'etat d'arrivee
% DM: et pas de depart
...
% DM: souvent n'est defini que pour x1<=x2 ce qui oblige a utiliser
% DM: une union abstraite juste avant
...
Boustr.c & 0.100s & 0.088s & \begin{tabular}{l}
 ...
 -2x.0 + 3d.0 + 2001 >= 0 \\
 -d.0 + 1 >= 0
\end{tabular}& $\subset$ & 0.064 & \begin{tabular}{l}
...
-i.0 + 100 >= 0 \\
i.0 >= 0
\end{tabular}& $\subset$ & 0.052 & \begin{tabular}{l}
-i.0 + 100 >= 0\\
r.0 >= 0 \\
i.0 - r.0 >= 0 \\
24i.0 - 25r.0 + 75 >= 0
...
x.0 - 51y.0 + 2550 >= 0 \\
x.0 >= 0
\end{tabular}& $\subset$ & 0.032 & \begin{tabular}{l}
y.0 >= 0
\end{tabular} \\ \hline
...
ex8.c & 0.516s & 0.408s & \begin{tabular}{l}
 ...
 y.0 - x.0 + 1 >= 0\\
 y.0 + x.0 + 1 >= 0
\end{tabular}& $\subset$ & 0.208 & \begin{tabular}{l}
-x.0 + 1 >= 0 \\
x.0 + 1 >= 0 
\end{tabular} \\ \hline
...
b.0 - c.0 + 1 >= 0\\
b.0 + c.0 + 1 >= 0\\
\end{tabular}& $\subset$ & 0.916s & \begin{tabular}{l}
-b.0 + 1 >= 0\\
-b.0 + a.0 + 1 >= 0\\
-c.0 + 1 >= 0\\
-c.0 + d.0 + 1 >= 0\\
...
b.0 - c.0 + 1 >= 0\\
b.0 + c.0 + 1 >= 0\\
\end{tabular}& $\subset$ & 36.30s & \begin{tabular}{l}
-b.0 + 1 >= 0 \\
-b.0 + a.0 + 1 >= 0\\
-c.0 + 1 >= 0\\
-c.0 + d.0 + 1 >= 0\\
...
automotive\_qsort1 & 7 & 3 & 6 & 16 \\ \hline
...
consumer\_jpeg\_c & 25 & 9 & 694 & 728 \\ \hline
consumer\_jpeg\_d & 22 & 9 & 661 & 692 \\ \hline
consumer\_lame & 24 & 30 & 361  & 415 \\ \hline
consumer\_mad & 9 & 20 & 567 & 596 \\ \hline
consumer\_tiff2bw & 10 & 24 & 561 & 595 \\ \hline
consumer\_tiff2rgba & 8 & 25 & 457 & 490\\ \hline
consumer\_tiffdither & 9 & 23 & 560 & 592 \\ \hline
consumer\_tiffmedian & 10 & 24 & 609 & 643 \\ \hline
network\_patricia & 2 & 0 & 21 & 23 \\ \hline
office\_rsynth & 8 & 1 & 157 & 166\\ \hline
office\_stringsearch1 & 2 & 2 & 46 & 50\\ \hline
security\_blowfish\_d & 0 & 1 & 26 & 27\\ \hline
security\_blowfish\_e & 0 & 1 & 26 & 27\\ \hline
...
telecom\_gsm & 4 & 1 & 88 & 93\\ \hline
\end{tabular}
\caption{Number of basicblocks where the computed invariant is more precise with
