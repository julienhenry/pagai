...
\begin{tikzpicture}[->,>=stealth',auto,node distance=1.5cm,
                    semithick,font=\footnotesize]
\tikzstyle{state}=[circle,fill=black!25,minimum size=12pt,inner sep=0pt]
\tikzstyle{transition}=[rectangle,thick,draw=black!75,
  			  fill=black!20,minimum size=4mm]
\tikzstyle{transition2}=[rectangle,thick,draw=blue!75,
  			  fill=blue!20,minimum size=4mm,blue]
  \tikzstyle{LabelStyle}=[fill=red,sloped]
\tikzstyle{PRstate}=[circle,fill=blue!25,minimum size=13pt,inner sep=0pt]
	\node[PRstate] (n0) {$n_0$};
	\node[PRstate] (n1) [below of=n0] {$n_1$};
...
\tikzstyle{line}=[black,thick]
	...
	%\draw<10->[line] (-1,-1) -- (10,10) -- cycle;
	%\fill<10->[polyhedra] (-1,-1) -- (10,10) -- (13,10) -- (13,-1) -- (0,-1) -- cycle;
	%\fill<12->[polyhedra] (0,0) -- (10,10) -- (13,10) -- (13,0) -- cycle;
	%\draw<12->[line] (0,0) -- (10,10) -- cycle;
