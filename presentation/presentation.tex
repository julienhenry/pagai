...
\section[Introduction]{Introduction: Witness of the standard approach}
...
%	\draw[->,blue,out=0,in=0] (n6) -| (n1.x,4) -- (n1);
%	\draw[->,blue] (n6) .. controls  +(0:4cm) and +(0:5cm) .. (n1);
\end{tikzpicture}
\end{column}
\begin{column}{5cm}
...
\tikzstyle{polyhedra}=[gray,opacity=0.5]
   ...
   %  			node[anchor=east] {\y}; 
	...
	\fill<2-6>[polyhedra] (0,0) circle (0.4);
	\draw<7-9>[polyhedra] (0,0) -- (10,10) -- cycle;
	\fill<10-15>[polyhedra] (0,0) -- (10,10) -- (10,-1) -- (0,-1) -- cycle;
\end{tikzpicture} 
\begin{tikzpicture}[y=.2cm, x=.2cm,font=\footnotesize]
\tikzstyle{polyhedra}=[blue]
 	%axis
	\draw (0,0) -- coordinate (x axis mid) (10,0);
    \draw (0,0) -- coordinate (y axis mid) (0,10);
