...
\institute[Verimag]{Verimag, CNRS \\ \texttt{Julien.Henry@imag.fr}}
...
\begin{frame}
\frametitle{Static Analysis \& Compilation}
\begin{itemize}
\item discover properties on programs
\item find program invariants, dead code\ldots
...
\visible<2->{$\Rightarrow$ upper approximation of the set of states}
\end{frame}
...
\section[Introduction]{Weakness of the standard approach}
