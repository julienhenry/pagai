...
Might be useful for WCET computation:
\begin{itemize}
	\item Path Focusing technique \\
		avoid unfeasible paths, delay least upper bound operations
	\item Disjunctive invariants \\
		more expressive abstract domain
\end{itemize}
\end{frame}
