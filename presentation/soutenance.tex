...
\tikzstyle{state}=[circle,draw=black,minimum size=13pt,inner sep=0pt]
\tikzstyle{transition}=[rectangle,draw=black!75,
  			  fill=black!20,minimum size=4mm]
\tikzstyle{transition2}=[rectangle,very thick,draw=blue!75,
...
color=blue]
\tikzstyle{line}=[black]
\tikzstyle{line2}=[blue,ultra thick]
...
\begin{tikzpicture}[y=.2cm, x=.2cm,font=\footnotesize]
	...
	\draw<8>[line] (0,0) -- (2,2) -- cycle;

	\draw<9-13>[line] (0,0) -- (10,10) -- cycle;


	\draw<10>[line2] (0,0) -- (8,8) -- cycle;

     		\draw<10> [dotted](8,8) -- (-3pt,8) 
     			node[anchor=east] {$51$}; 
     		\draw<10> [dotted] (8,8) -- (8,-3pt) 
     			node[anchor=north] {$51$}; 


	\draw<14-15>[line] (-1,-1) -- (10,10) -- cycle;
	\fill<14-15>[polyhedra] (-1,-1) -- (10,10) -- (13,10) -- (13,-1) -- (0,-1) -- cycle;
	\fill<16-17>[polyhedra] (0,0) -- (10,10) -- (13,10) -- (13,0) -- cycle;
	\draw<16-17>[line] (0,0) -- (10,10) -- cycle;
    ...
    \draw<7-8> (1pt,2) -- (-3pt,2) 
     	node[anchor=east] {1}; 
    \draw<7-8> (2,1pt) -- (2,-3pt) 
     	node[anchor=north] {1}; 
...
\begin{tikzpicture}[y=.2cm, x=.2cm,font=\footnotesize]
	...
	\node (t1) at (-5,-4) {};
	\node (t2) at (13,11) {};
	\fill<4-12>[line] (0,2) circle (0.4);
	\fill<13-14>[polyhedra] (0,2) -- (8,10) -- (12,10) -- (8,6) --cycle;
	\draw<13-14>[line] (0,2) -- (6,8);
	\draw<13-14>[line] (8,6) -- (12,10);

	\draw<15-16>[line] (-2,0) -- (8,10);
	\fill<15-16>[polyhedra] (-2,-2) -- (-2,0) -- (8,10) -- (13,10) -- (13,-2) --
	 cycle;
	%\fill<12-13>[polyhedra] (-2,-2) -- (-2,0) -- (6,8) -- (6,-2) -- cycle;
	%\fill<12-14>[polyhedra] (8,6) -- (12,10) -- (13,10) -- (13,-2) -- (8,-2) -- cycle;

	\draw<17>[line] (0,2) -- (8,10);
	\draw<17>[line] (0,2) -- (8,-2);
	\draw<17>[line] (13,-2) -- (8,-2);
	\fill<17>[polyhedra] (0,2) -- (8,10) -- (13,10) -- (13,-2) -- (8,-2) -- cycle;
	...
	%ticks
     		\draw<4-> (1pt,2) -- (-3pt,2) 
     			node[anchor=east] {1}; 
     		\draw<17-> [dotted](8,-2) -- (-3pt,-2) 
     			node[anchor=east] {-1}; 
	
     		\draw<13-14> [dotted](6,8) -- (-3pt,8) 
     			node[anchor=east] {$51$}; 
     		\draw<13-14> [dotted] (8,6) -- (-3pt,6) 
     			node[anchor=east] {$50$}; 
     		\draw<13-14> [dotted](8,6) -- (8,-3pt) 
     			node[anchor=north] {$51$}; 
     		\draw<13-14> [dotted] (6,8) -- (6,-3pt) 
     			node[anchor=north] {$50$}; 
     		\draw<17-> [dotted](8,6) -- (8,-2.3) 
     			node[anchor=north] {$51$}; 
...
\end{tikzpicture} 
\only<1-15>{Ascending iterations}
\only<16->{Descending iterations}
\end{column}
\end{columns}
\end{frame}
