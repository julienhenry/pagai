...
automotive or avionics): a rate limiter. For the sake of simplicity, we chose it
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.75]{gopan_reps}
\end{center}
...
%
Our tool operates over LLVM bitcode \cite{LLVM_langref,Lattner:2004:LCF:977395.977673}, which is a target for several compilers, most notably Clang (supporting C and C++) and llvm-gcc (supporting C, C++, Fortran and Ada).
