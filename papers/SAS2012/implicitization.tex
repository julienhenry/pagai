...
line in the code: for instance, $p_3$ corresponds to the header of the main
loop.
...
For instance, the loop \lstinline|for (int i=0; i<n; i++) {...}| has head invariant $0 \leq i \leq n \lor (i=0 \land n<0)$.
...
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: "implicitization_lmcs.tex"
