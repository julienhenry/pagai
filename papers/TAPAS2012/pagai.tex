...
\begin{frontmatter}
  ...
  \address{VERIMAG\\ Universit\'e Joseph Fourier\\
    Grenoble, France} 
	\author{David Monniaux\thanksref{imag.fr}}
  \address{VERIMAG\\CNRS\\
    Grenoble, France} 
	\author{Matthieu Moy\thanksref{grenoble-inp.fr}}
  \address{VERIMAG\\Grenoble-INP\\
    Grenoble, France} 
...
\begin{abstract} 
	...
	Interpretation and Decision Procedures (SMT-solving), and offers
	several abstract domains.
...
This tool uses the LLVM compiler infrastructure.

Several other verification tools already use the LLVM framework, such as
Calysto, KLEE, LAV, LLBMC.

Our tool is dedicated to experiment various combination of analysis techniques
by abstract interpretation.
Indeed, depending on the iteration strategy, the choice of the abstract domain,
etc, precision and cost of the analysis hugely vary. Our platform allows to
compare various state-of-the-art techniques and abstract domains on real life
...
SMT-Lib 2 standard \cite{BarST-SMTLIB} through a pipe.
