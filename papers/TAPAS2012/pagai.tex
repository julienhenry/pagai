...
% TODO: citer des réfs sur APRON, les octogones etc.



Abstract interpretation is a , which computes inductive invariants at various control points of an
imperative program. Linear relation analysis (LRA) is an application of
this framework, where the invariants are conjunctions of linear inequalities (or, equivalently, convex polyhedra), or, possibly, disjunctions of such conjunctions (or, equivalently, unions of convex polyhedra).
