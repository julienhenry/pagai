...
which is a target for several industrial-strengh compilers, most notably Clang (supporting C and
C++) and llvm-gcc (supporting C, C++, Fortran and Ada).
...
These techniques make a precise analysis of the paths inside the program
