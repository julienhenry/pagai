...
\MM{Je trouve qu'il manque une vue de haut niveau quelque part par ici. Dire qu'en gros, l'algo, c'est :

\begin{algorithm}
  \begin{algorithmic}
    \STATE \textit{Subset} $\gets \emptyset$
    \WHILE{true}
    \STATE Ascending iteration on a \textit{Subset}
    \STATE Narrow
    \STATE Add new paths to \textit{Subset}
    \ENDWHILE
  \end{algorithmic}
\end{algorithm}
