...
\begin{table*}
\begin{center}
\begin{tabular}{|l|rrr|rrr|rrr|rrr|rrr|} \hline
...
& \multicolumn{1}{c}{$\subsetneq$} & \multicolumn{1}{c}{$\supsetneq$} & inc.
& \multicolumn{1}{c}{$\subsetneq$} & \multicolumn{1}{c}{$\supsetneq$} & inc.
& \multicolumn{1}{c}{$\subsetneq$} & \multicolumn{1}{c}{$\supsetneq$} & inc.
& \multicolumn{1}{c}{$\subsetneq$} & \multicolumn{1}{c}{$\supsetneq$} & inc.
& \multicolumn{1}{c}{$\subsetneq$} & \multicolumn{1}{c}{$\supsetneq$} & inc. \\
...
The $\subseteq$ column gives the percentage of invariants more precise (smaller with respect to inclusion) with the left-side technique,
$\subseteq$ the percentage of invariants better with the right-side technique,
and ``inc.'' gives the percentage of invariants that are incomparable, i.e
neither greater nor smaller.}
% TODO: le reste c'est quand c'est egal?
...
``unknown'' result.
This limitation occured very rarely in our experiments, except for the analysis
