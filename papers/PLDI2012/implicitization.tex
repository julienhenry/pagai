...
Following recent suggestions \cite{Gawlitza_Monniaux_ESOP11,Monniaux_Gonnord_SAS11}, we avoid this space explosion by keeping the second program implicit and working from the first program, yet simulating the analysis of the second program, that is, on a transition multigraph (Fig.~\ref{fig:multigraph}).
...
\section{Guided static analysis}
