...
\begin{figure}
\begin{center}
\includegraphics{figures/gopan_reps}
\end{center}
...
A first benefit is to limit the number of dimensions in the abstract values, since polyhedra libraries typically perform worse with higher dimensions.
A second benefit is that the abstract operation for a single path in path-focusing methods also is a (large) parallel assignment.
