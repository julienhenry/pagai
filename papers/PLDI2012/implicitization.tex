...
regularly yields greater invariants than the domains of octagons/intervals.
Experiences shows is it mostly due to the widening operator.
The Octagon domain appears to be much better than intervals.
\JH{Commenter les resultats}

Analysis of linear equalities (PKEQ) performs very fast compared
to other abstract domains, but yields very unprecise invariants.
